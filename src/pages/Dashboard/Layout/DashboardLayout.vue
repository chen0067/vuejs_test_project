  ...
  <div class="wrapper" :class="{'nav-open': $sidebar.showSidebar}">
    ...
    <side-bar>
      <template slot="links">
        ...
        <sidebar-item
          :link="{name: 'Question 1', icon: 'now-ui-icons objects_diamond', path: '/question1'}"></sidebar-item>
        <sidebar-item
          :link="{name: 'Question 2', icon: 'now-ui-icons objects_diamond', path: '/question2'}"></sidebar-item>
        <!-- <sidebar-item
