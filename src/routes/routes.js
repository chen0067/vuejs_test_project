...
// Question 1
const Question1 = () =>
  import(/* webpackChunkName: "charts" */ 'src/pages/Dashboard/Question1.vue');

// Question 2
const Question2 = () =>
  import(/* webpackChunkName: "charts" */ 'src/pages/Dashboard/Question2.vue');
  ...
  authPages,
  {
    ...
    children: [
      ...
      },
      {
        path: 'question1',
        name: 'Question 1',
        components: { default: Question1, header: DefaultHeader }
      },
      {
        path: 'question2',
        name: 'Question 2',
        components: { default: Question2, header: DefaultHeader }
      },
      // {
      //   path: 'charts',
      //   name: 'Charts',
